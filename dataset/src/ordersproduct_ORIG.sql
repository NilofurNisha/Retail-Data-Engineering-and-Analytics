CREATE DATABASE /*!32312 IF NOT EXISTS*/`ordersproducts` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
(10100,'2016-10-06','2016-10-13','2016-10-10','Shipped',NULL,363),

(10101,'2016-10-09','2016-10-18','2016-10-11','Shipped','Check on availability.',128),

(10102,'2016-10-10','2016-10-18','2016-10-14','Shipped',NULL,181),

(10103,'2016-10-29','2016-10-07','2016-10-02','Shipped',NULL,121),

(10104,'2016-10-31','2016-10-09','2016-10-01','Shipped',NULL,141),

(10105,'2016-10-11','2016-10-21','2016-10-12','Shipped',NULL,145),

(10106,'2016-10-17','2016-10-24','2016-10-21','Shipped',NULL,278),

(10107,'2016-10-24','2016-10-03','2016-10-26','Shipped','Difficult to negotiate with customer. We need more marketing materials',131),

(10108,'2016-10-03','2016-10-12','2016-10-08','Shipped',NULL,385),

(10109,'2016-10-10','2016-10-19','2016-10-11','Shipped','Customer requested that FedEx Ground is used for this shipping',486),

(10110,'2016-10-18','2016-10-24','2016-10-20','Shipped',NULL,187),

(10111,'2016-10-25','2016-10-31','2016-10-30','Shipped',NULL,129),

(10112,'2016-10-24','2016-10-03','2016-10-29','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment',144),

(10113,'2016-10-26','2016-10-02','2016-10-27','Shipped',NULL,124),

(10114,'2016-10-01','2016-10-07','2016-10-02','Shipped',NULL,172),

(10115,'2016-10-04','2016-10-12','2016-10-07','Shipped',NULL,424),

(10116,'2016-10-11','2016-10-19','2016-10-13','Shipped',NULL,381),

(10117,'2016-10-16','2016-10-24','2016-10-17','Shipped',NULL,148),

(10118,'2016-10-21','2016-10-29','2016-10-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',216),

(10119,'2016-10-28','2016-10-05','2016-10-02','Shipped',NULL,382),

(10120,'2016-10-29','2016-10-08','2016-10-01','Shipped',NULL,114),

(10121,'2016-10-07','2016-10-13','2016-10-13','Shipped',NULL,353),

(10122,'2016-10-08','2016-10-16','2016-10-13','Shipped',NULL,350),

(10123,'2016-10-20','2016-10-29','2016-10-22','Shipped',NULL,103),

(10124,'2016-10-21','2016-10-29','2016-10-25','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',112),

(10125,'2016-10-21','2016-10-27','2016-10-24','Shipped',NULL,114),

(10126,'2016-10-28','2016-10-07','2016-10-02','Shipped',NULL,458),

(10127,'2016-10-03','2016-10-09','2016-10-06','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',151),

(10128,'2016-10-06','2016-10-12','2016-10-11','Shipped',NULL,141),

(10129,'2016-10-12','2016-10-18','2016-10-14','Shipped',NULL,324),

(10130,'2016-10-16','2016-10-24','2016-10-21','Shipped',NULL,198),

(10131,'2016-10-16','2016-10-25','2016-10-21','Shipped',NULL,447),

(10132,'2016-10-25','2016-10-01','2016-10-28','Shipped',NULL,323),

(10133,'2016-10-27','2016-10-04','2016-10-03','Shipped',NULL,141),

(10134,'2016-10-01','2016-10-10','2016-10-05','Shipped',NULL,250),

(10135,'2016-10-02','2016-10-12','2016-10-03','Shipped',NULL,124),

(10136,'2016-10-04','2016-10-14','2016-10-06','Shipped','Customer is interested in buying more Ferrari models',242),

(10137,'2016-10-10','2016-10-20','2016-10-14','Shipped',NULL,353),

(10138,'2016-10-07','2016-10-16','2016-10-13','Shipped',NULL,496),

(10139,'2016-10-16','2016-10-23','2016-10-21','Shipped',NULL,282),

(10140,'2016-10-24','2016-10-02','2016-10-30','Shipped',NULL,161),

(10141,'2016-10-01','2016-10-09','2016-10-04','Shipped',NULL,334),

(10142,'2016-10-08','2016-10-16','2016-10-13','Shipped',NULL,124),

(10143,'2016-10-10','2016-10-18','2016-10-12','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',320),

(10144,'2016-10-13','2016-10-21','2016-10-14','Shipped',NULL,381),

(10145,'2016-10-25','2016-10-02','2016-10-31','Shipped',NULL,205),

(10146,'2016-10-03','2016-10-13','2016-10-06','Shipped',NULL,447),

(10147,'2016-10-05','2016-10-12','2016-10-09','Shipped',NULL,379),

(10148,'2016-10-11','2016-10-21','2016-10-15','Shipped','They want to reevaluate their terms agreement with Finance.',276),

(10149,'2016-10-12','2016-10-18','2016-10-17','Shipped',NULL,487),

(10150,'2016-10-19','2016-10-27','2016-10-21','Shipped','They want to reevaluate their terms agreement with Finance.',148),

(10151,'2016-10-21','2016-10-30','2016-10-24','Shipped',NULL,311),

(10152,'2016-10-25','2016-10-03','2016-10-01','Shipped',NULL,333),

(10153,'2016-10-28','2016-10-05','2016-10-03','Shipped',NULL,141),

(10154,'2016-10-02','2016-10-12','2016-10-08','Shipped',NULL,219),

(10155,'2016-10-06','2016-10-13','2016-10-07','Shipped',NULL,186),

(10156,'2016-10-08','2016-10-17','2016-10-11','Shipped',NULL,141),

(10157,'2016-10-09','2016-10-15','2016-10-14','Shipped',NULL,473),

(10158,'2016-10-10','2016-10-18','2016-10-15','Shipped',NULL,121),

(10159,'2016-10-10','2016-10-19','2016-10-16','Shipped',NULL,321),

(10160,'2016-10-11','2016-10-17','2016-10-17','Shipped',NULL,347),

(10161,'2016-10-17','2016-10-25','2016-10-20','Shipped',NULL,227),

(10162,'2016-10-18','2016-10-26','2016-10-19','Shipped',NULL,321),

(10163,'2016-10-20','2016-10-27','2016-10-24','Shipped',NULL,424),

(10164,'2016-10-21','2016-10-30','2016-10-23','Resolved','This order was disputed, but resolved on 11/1/2016; Customer doesn\'t like the colors and precision of the models.',452),

(10165,'2016-10-22','2016-10-31','2016-10-26','Shipped','This order was on hold because customers\'s credit limit had been exceeded. Order will ship when payment is received',148),

(10166,'2016-10-21','2016-10-30','2016-10-27','Shipped',NULL,462),

(10167,'2016-10-23','2016-10-30',NULL,'Cancelled','Customer called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.',448),

(10168,'2016-10-28','2016-10-03','2016-10-01','Shipped',NULL,161),

(10169,'2016-10-04','2016-10-14','2016-10-09','Shipped',NULL,276),

(10170,'2016-10-04','2016-10-12','2016-10-07','Shipped',NULL,452),

(10171,'2016-10-05','2016-10-13','2016-10-07','Shipped',NULL,233),

(10172,'2016-10-05','2016-10-14','2016-10-11','Shipped',NULL,175),

(10173,'2016-10-05','2016-10-15','2016-10-09','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',278),

(10174,'2016-10-06','2016-10-15','2016-10-10','Shipped',NULL,333),

(10175,'2016-10-06','2016-10-14','2016-10-09','Shipped',NULL,324),

(10176,'2016-10-06','2016-10-15','2016-10-12','Shipped',NULL,386),

(10177,'2016-10-07','2016-10-17','2016-10-12','Shipped',NULL,344),

(10178,'2016-10-08','2016-10-16','2016-10-10','Shipped','Custom shipping instructions sent to warehouse',242),

(10179,'2016-10-11','2016-10-17','2016-10-13','Cancelled','Customer cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.',496),

(10180,'2016-10-11','2016-10-19','2016-10-14','Shipped',NULL,171),

(10181,'2016-10-12','2016-10-19','2016-10-15','Shipped',NULL,167),

(10182,'2016-10-12','2016-10-21','2016-10-18','Shipped',NULL,124),

(10183,'2016-10-13','2016-10-22','2016-10-15','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',339),

(10184,'2016-10-14','2016-10-22','2016-10-20','Shipped',NULL,484),

(10185,'2016-10-14','2016-10-21','2016-10-20','Shipped',NULL,320),

(10186,'2016-10-14','2016-10-20','2016-10-18','Shipped','They want to reevaluate their terms agreement with the VP of Sales',489),

(10187,'2016-10-15','2016-10-24','2016-10-16','Shipped',NULL,211),

(10188,'2016-10-18','2016-10-26','2016-10-24','Shipped',NULL,167),

(10189,'2016-10-18','2016-10-25','2016-10-24','Shipped','They want to reevaluate their terms agreement with Finance.',205),

(10190,'2016-10-19','2016-10-29','2016-10-20','Shipped',NULL,141),

(10191,'2016-10-20','2016-10-30','2016-10-24','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',259),

(10192,'2016-10-20','2016-10-29','2016-10-25','Shipped',NULL,363),

(10193,'2016-10-21','2016-10-28','2016-10-27','Shipped',NULL,471),

(10194,'2016-10-25','2016-10-02','2016-10-26','Shipped',NULL,146),

(10195,'2016-10-25','2016-10-01','2016-10-28','Shipped',NULL,319),

(10196,'2016-10-26','2016-10-03','2016-10-01','Shipped',NULL,455),

(10197,'2016-10-26','2016-10-02','2016-10-01','Shipped','Customer inquired about remote controlled models and gold models.',216),

(10198,'2016-10-27','2016-10-06','2016-10-03','Shipped',NULL,385),

(10199,'2016-10-01','2016-10-10','2016-10-06','Shipped',NULL,475),

(10200,'2016-10-01','2016-10-09','2016-10-06','Shipped',NULL,211),

(10201,'2016-10-01','2016-10-11','2016-10-02','Shipped',NULL,129),

(10202,'2016-10-02','2016-10-09','2016-10-06','Shipped',NULL,357),

(10203,'2016-10-02','2016-10-11','2016-10-07','Shipped',NULL,141),

(10204,'2016-10-02','2016-10-10','2016-10-04','Shipped',NULL,151),

(10205,'2016-10-03','2016-10-09','2016-10-07','Shipped',' I need all the information I can get on our competitors.',141),

(10206,'2016-10-05','2016-10-13','2016-10-08','Shipped','Can we renegotiate this one?',202),

(10207,'2016-10-09','2016-10-17','2016-10-11','Shipped','Check on availability.',495),

(10208,'2016-10-02','2016-10-11','2016-10-04','Shipped',NULL,146),

(10209,'2016-10-09','2016-10-15','2016-10-12','Shipped',NULL,347),

(10210,'2016-10-12','2016-10-22','2016-10-20','Shipped',NULL,177),

(10211,'2016-10-15','2016-10-25','2016-10-18','Shipped',NULL,406),

(10212,'2016-10-16','2016-10-24','2016-10-18','Shipped',NULL,141),

(10213,'2016-10-22','2016-10-28','2016-10-27','Shipped','Difficult to negotiate with customer. We need more marketing materials',489),

(10214,'2016-10-26','2016-10-04','2016-10-29','Shipped',NULL,458),

(10215,'2016-10-29','2016-10-08','2016-10-01','Shipped','Customer requested that FedEx Ground is used for this shipping',475),

(10216,'2016-10-02','2016-10-10','2016-10-04','Shipped',NULL,256),

(10217,'2016-10-04','2016-10-14','2016-10-06','Shipped',NULL,166),

(10218,'2016-10-09','2016-10-16','2016-10-11','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment',473),

(10219,'2016-10-10','2016-10-17','2016-10-12','Shipped',NULL,487),

(10220,'2016-10-12','2016-10-19','2016-10-16','Shipped',NULL,189),

(10221,'2016-10-18','2016-10-26','2016-10-19','Shipped',NULL,314),

(10222,'2016-10-19','2016-10-27','2016-10-20','Shipped',NULL,239),

(10223,'2016-10-20','2016-10-29','2016-10-24','Shipped',NULL,114),

(10224,'2016-10-21','2016-10-02','2016-10-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',171),

(10225,'2016-10-22','2016-10-01','2016-10-24','Shipped',NULL,298),

(10226,'2016-10-26','2016-10-06','2016-10-02','Shipped',NULL,239),

(10227,'2016-10-02','2016-10-12','2016-10-08','Shipped',NULL,146),

(10228,'2016-10-10','2016-10-18','2016-10-13','Shipped',NULL,173),

(10229,'2016-10-11','2016-10-20','2016-10-12','Shipped',NULL,124),

(10230,'2016-10-15','2016-10-24','2016-10-20','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',128),

(10231,'2016-10-19','2016-10-26','2016-10-25','Shipped',NULL,344),

(10232,'2016-10-20','2016-10-30','2016-10-25','Shipped',NULL,240),

(10233,'2016-10-29','2016-10-04','2016-10-02','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',328),

(10234,'2016-10-30','2016-10-05','2016-10-02','Shipped',NULL,412),

(10235,'2016-10-02','2016-10-12','2016-10-06','Shipped',NULL,260),

(10236,'2016-10-03','2016-10-11','2016-10-08','Shipped',NULL,486),

(10237,'2016-10-05','2016-10-12','2016-10-10','Shipped',NULL,181),

(10238,'2016-10-09','2016-10-16','2016-10-10','Shipped',NULL,145),

(10239,'2016-10-12','2016-10-21','2016-10-17','Shipped',NULL,311),

(10240,'2016-10-13','2016-10-20','2016-10-20','Shipped',NULL,177),

(10241,'2016-10-13','2016-10-20','2016-10-19','Shipped',NULL,209),

(10242,'2016-10-20','2016-10-28','2016-10-25','Shipped','Customer is interested in buying more Ferrari models',456),

(10243,'2016-10-26','2016-10-03','2016-10-28','Shipped',NULL,495),

(10244,'2016-10-29','2016-10-09','2016-10-04','Shipped',NULL,141),

(10245,'2016-10-04','2016-10-12','2016-10-09','Shipped',NULL,455),

(10246,'2016-10-05','2016-10-13','2016-10-06','Shipped',NULL,141),

(10247,'2016-10-05','2016-10-11','2016-10-08','Shipped',NULL,334),

(10248,'2016-10-07','2016-10-14',NULL,'Cancelled','Order was mistakenly placed. The warehouse noticed the lack of documentation.',131),

(10249,'2016-10-08','2016-10-17','2016-10-11','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',173),

(10250,'2016-10-11','2016-10-19','2016-10-15','Shipped',NULL,450),

(10251,'2016-10-18','2016-10-24','2016-10-24','Shipped',NULL,328),

(10252,'2016-10-26','2016-10-04','2016-10-29','Shipped',NULL,406),

(10253,'2016-10-01','2016-10-09','2016-10-02','Cancelled','Customer disputed the order and we agreed to cancel it. We must be more cautions with this customer going forward, since they are very hard to please. We must cover the shipping fees.',201),

(10254,'2016-10-03','2016-10-13','2016-10-04','Shipped','Customer requested that DHL is used for this shipping',323),

(10255,'2016-10-04','2016-10-12','2016-10-09','Shipped',NULL,209),

(10256,'2016-10-08','2016-10-16','2016-10-10','Shipped',NULL,145),

(10257,'2016-10-14','2016-10-24','2016-10-15','Shipped',NULL,450),

(10258,'2016-10-15','2016-10-25','2016-10-23','Shipped',NULL,398),

(10259,'2016-10-15','2016-10-22','2016-10-17','Shipped',NULL,166),

(10260,'2016-10-16','2016-10-22',NULL,'Cancelled','Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.',357),

(10261,'2016-10-17','2016-10-25','2016-10-22','Shipped',NULL,233),

(10262,'2016-10-24','2016-10-01',NULL,'Cancelled','This customer found a better offer from one of our competitors. Will call back to renegotiate.',141),

(10263,'2016-10-28','2016-10-04','2016-10-02','Shipped',NULL,175),

(10264,'2016-10-30','2016-10-06','2016-10-01','Shipped','Customer will send a truck to our local warehouse on 7/1/2016',362),

(10265,'2016-10-02','2016-10-09','2016-10-07','Shipped',NULL,471),

(10266,'2016-10-06','2016-10-14','2016-10-10','Shipped',NULL,386),

(10267,'2016-10-07','2016-10-17','2016-10-09','Shipped',NULL,151),

(10268,'2016-10-12','2016-10-18','2016-10-14','Shipped',NULL,412),

(10269,'2016-10-16','2016-10-22','2016-10-18','Shipped',NULL,382),

(10270,'2016-10-19','2016-10-27','2016-10-24','Shipped','Can we renegotiate this one?',282),

(10271,'2016-10-20','2016-10-29','2016-10-23','Shipped',NULL,124),

(10272,'2016-10-20','2016-10-26','2016-10-22','Shipped',NULL,157),

(10273,'2016-10-21','2016-10-28','2016-10-22','Shipped',NULL,314),

(10274,'2016-10-21','2016-10-29','2016-10-22','Shipped',NULL,379),

(10275,'2016-10-23','2016-10-02','2016-10-29','Shipped',NULL,119),

(10276,'2016-10-02','2016-10-11','2016-10-08','Shipped',NULL,204),

(10277,'2016-10-04','2016-10-12','2016-10-05','Shipped',NULL,148),

(10278,'2016-10-06','2016-10-16','2016-10-09','Shipped',NULL,112),

(10279,'2016-10-09','2016-10-19','2016-10-15','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',141),

(10280,'2016-10-17','2016-10-27','2016-10-19','Shipped',NULL,249),

(10281,'2016-10-19','2016-10-28','2016-10-23','Shipped',NULL,157),

(10282,'2016-10-20','2016-10-26','2016-10-22','Shipped',NULL,124),

(10283,'2016-10-20','2016-10-30','2016-10-23','Shipped',NULL,260),

(10284,'2016-10-21','2016-10-29','2016-10-26','Shipped','Custom shipping instructions sent to warehouse',299),

(10285,'2016-10-27','2016-10-04','2016-10-31','Shipped',NULL,286),

(10286,'2016-10-28','2016-10-06','2016-10-01','Shipped',NULL,172),

(10287,'2016-10-30','2016-10-06','2016-10-01','Shipped',NULL,298),

(10288,'2016-10-01','2016-10-11','2016-10-05','Shipped',NULL,166),

(10289,'2016-10-03','2016-10-13','2016-10-04','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',167),

(10290,'2016-10-07','2016-10-15','2016-10-13','Shipped',NULL,198),

(10291,'2016-10-08','2016-10-17','2016-10-14','Shipped',NULL,448),

(10292,'2016-10-08','2016-10-18','2016-10-11','Shipped','They want to reevaluate their terms agreement with Finance.',131),

(10293,'2016-10-09','2016-10-18','2016-10-14','Shipped',NULL,249),

(10294,'2016-10-10','2016-10-17','2016-10-14','Shipped',NULL,204),

(10295,'2016-10-10','2016-10-17','2016-10-14','Shipped','They want to reevaluate their terms agreement with Finance.',362),

(10296,'2016-10-15','2016-10-22','2016-10-16','Shipped',NULL,415),

(10297,'2016-10-16','2016-10-22','2016-10-21','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',189),

(10298,'2016-10-27','2016-10-05','2016-10-01','Shipped',NULL,103),

(10299,'2016-10-30','2016-10-10','2016-10-01','Shipped',NULL,186),

(10300,'2016-10-04','2016-10-13','2016-10-09','Shipped',NULL,128),

(10301,'2016-10-05','2016-10-15','2016-10-08','Shipped',NULL,299),

(10302,'2016-10-06','2016-10-16','2016-10-07','Shipped',NULL,201),

(10303,'2016-10-06','2016-10-14','2016-10-09','Shipped','Customer inquired about remote controlled models and gold models.',484),

(10304,'2016-10-11','2016-10-20','2016-10-17','Shipped',NULL,256),

(10305,'2016-10-13','2016-10-22','2016-10-15','Shipped','Check on availability.',286),

(10306,'2016-10-14','2016-10-21','2016-10-17','Shipped',NULL,187),

(10307,'2016-10-14','2016-10-23','2016-10-20','Shipped',NULL,339),

(10308,'2016-10-15','2016-10-24','2016-10-20','Shipped','Customer requested that FedEx Ground is used for this shipping',319),

(10309,'2016-10-15','2016-10-24','2016-10-18','Shipped',NULL,121),

(10310,'2016-10-16','2016-10-24','2016-10-18','Shipped',NULL,259),

(10311,'2016-10-16','2016-10-23','2016-10-20','Shipped','Difficult to negotiate with customer. We need more marketing materials',141),

(10312,'2016-10-21','2016-10-27','2016-10-23','Shipped',NULL,124),

(10313,'2016-10-22','2016-10-28','2016-10-25','Shipped','Customer requested that FedEx Ground is used for this shipping',202),

(10314,'2016-10-22','2016-10-01','2016-10-23','Shipped',NULL,227),

(10315,'2016-10-29','2016-10-08','2016-10-30','Shipped',NULL,119),

(10316,'2016-10-01','2016-10-09','2016-10-07','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment',240),

(10317,'2016-10-02','2016-10-12','2016-10-08','Shipped',NULL,161),

(10318,'2016-10-02','2016-10-09','2016-10-07','Shipped',NULL,157),

(10319,'2016-10-03','2016-10-11','2016-10-06','Shipped','Customer requested that DHL is used for this shipping',456),

(10320,'2016-10-03','2016-10-13','2016-10-07','Shipped',NULL,144),

(10321,'2016-10-04','2016-10-12','2016-10-07','Shipped',NULL,462),

(10322,'2016-10-04','2016-10-12','2016-10-10','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',363),

(10323,'2016-10-05','2016-10-12','2016-10-09','Shipped',NULL,128),

(10324,'2016-10-05','2016-10-11','2016-10-08','Shipped',NULL,181),

(10325,'2016-10-05','2016-10-13','2016-10-08','Shipped',NULL,121),

(10326,'2016-10-09','2016-10-16','2016-10-10','Shipped',NULL,144),

(10327,'2016-10-10','2016-10-19','2016-10-13','Resolved','Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models don\'t match what was discussed.',145),

(10328,'2016-10-12','2016-10-21','2016-10-18','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',278),

(10329,'2016-10-15','2016-10-24','2016-10-16','Shipped',NULL,131),

(10330,'2016-10-16','2016-10-25','2016-10-21','Shipped',NULL,385),

(10331,'2016-10-17','2016-10-23','2016-10-23','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',486),

(10332,'2016-10-17','2016-10-25','2016-10-18','Shipped',NULL,187),

(10333,'2016-10-18','2016-10-27','2016-10-20','Shipped',NULL,129),

(10334,'2016-10-19','2016-10-28',NULL,'On Hold','The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.',144),

(10335,'2016-10-19','2016-10-29','2016-10-23','Shipped',NULL,124),

(10336,'2016-10-20','2016-10-26','2016-10-24','Shipped','Customer requested that DHL is used for this shipping',172),

(10337,'2016-10-21','2016-10-30','2016-10-26','Shipped',NULL,424),

(10338,'2016-10-22','2016-10-02','2016-10-27','Shipped',NULL,381),

(10339,'2016-10-23','2016-10-30','2016-10-30','Shipped',NULL,398),

(10340,'2016-10-24','2016-10-01','2016-10-25','Shipped','Customer is interested in buying more Ferrari models',216),

(10341,'2016-10-24','2016-10-01','2016-10-29','Shipped',NULL,382),

(10342,'2016-10-24','2016-10-01','2016-10-29','Shipped',NULL,114),

(10343,'2016-10-24','2016-10-01','2016-10-26','Shipped',NULL,353),

(10344,'2016-10-25','2016-10-02','2016-10-29','Shipped',NULL,350),

(10345,'2016-10-25','2016-10-01','2016-10-26','Shipped',NULL,103),

(10346,'2016-10-29','2016-10-05','2016-10-30','Shipped',NULL,112),

(10347,'2016-10-29','2016-10-07','2016-10-30','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',114),

(10348,'2016-10-01','2016-10-08','2016-10-05','Shipped',NULL,458),

(10349,'2016-10-01','2016-10-07','2016-10-03','Shipped',NULL,151),

(10350,'2016-10-02','2016-10-08','2016-10-05','Shipped',NULL,141),

(10351,'2016-10-03','2016-10-11','2016-10-07','Shipped',NULL,324),

(10352,'2016-10-03','2016-10-12','2016-10-09','Shipped',NULL,198),

(10353,'2016-10-04','2016-10-11','2016-10-05','Shipped',NULL,447),

(10354,'2016-10-04','2016-10-10','2016-10-05','Shipped',NULL,323),

(10355,'2016-10-07','2016-10-14','2016-10-13','Shipped',NULL,141),

(10356,'2016-10-09','2016-10-15','2016-10-12','Shipped',NULL,250),

(10357,'2016-10-10','2016-10-16','2016-10-14','Shipped',NULL,124),

(10358,'2016-10-10','2016-10-16','2016-10-16','Shipped','Customer requested that DHL is used for this shipping',141),

(10359,'2016-10-15','2016-10-23','2016-10-18','Shipped',NULL,353),

(10360,'2016-10-16','2016-10-22','2016-10-18','Shipped',NULL,496),

(10361,'2016-10-17','2016-10-24','2016-10-20','Shipped',NULL,282),

(10362,'2016-10-05','2016-10-16','2016-10-10','Shipped',NULL,161),

(10363,'2016-10-06','2016-10-12','2016-10-10','Shipped',NULL,334),

(10364,'2016-10-06','2016-10-17','2016-10-09','Shipped',NULL,350),

(10365,'2016-10-07','2016-10-18','2016-10-11','Shipped',NULL,320),

(10366,'2016-10-10','2016-10-19','2016-10-12','Shipped',NULL,381),

(10367,'2016-10-12','2016-10-21','2016-10-16','Resolved','This order was disputed and resolved on 2/1/2016. Customer claimed that container with shipment was damaged. FedEx\'s investigation proved this wrong.',205),

(10368,'2016-10-19','2016-10-27','2016-10-24','Shipped','Can we renegotiate this one?',124),

(10369,'2016-10-20','2016-10-28','2016-10-24','Shipped',NULL,379),

(10370,'2016-10-20','2016-10-01','2016-10-25','Shipped',NULL,276),

(10371,'2016-10-23','2016-10-03','2016-10-25','Shipped',NULL,124),

(10372,'2016-10-26','2016-10-05','2016-10-28','Shipped',NULL,398),

(10373,'2016-10-31','2016-10-08','2016-10-06','Shipped',NULL,311),

(10374,'2016-10-02','2016-10-09','2016-10-03','Shipped',NULL,333),

(10375,'2016-10-03','2016-10-10','2016-10-06','Shipped',NULL,119),

(10376,'2016-10-08','2016-10-18','2016-10-13','Shipped',NULL,219),

(10377,'2016-10-09','2016-10-21','2016-10-12','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',186),

(10378,'2016-10-10','2016-10-18','2016-10-11','Shipped',NULL,141),

(10379,'2016-10-10','2016-10-18','2016-10-11','Shipped',NULL,141),

(10380,'2016-10-16','2016-10-24','2016-10-18','Shipped',NULL,141),

(10381,'2016-10-17','2016-10-25','2016-10-18','Shipped',NULL,321),

(10382,'2016-10-17','2016-10-23','2016-10-18','Shipped','Custom shipping instructions sent to warehouse',124),

(10383,'2016-10-22','2016-10-02','2016-10-25','Shipped',NULL,141),

(10384,'2016-10-23','2016-10-06','2016-10-27','Shipped',NULL,321),

(10385,'2016-10-28','2016-10-09','2016-10-01','Shipped',NULL,124),

(10386,'2016-10-01','2016-10-09','2016-10-06','Resolved','Disputed then Resolved on 3/15/2016. Customer doesn\'t like the craftsmaship of the models.',141),

(10387,'2016-10-02','2016-10-09','2016-10-06','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',148),

(10388,'2016-10-03','2016-10-11','2016-10-09','Shipped',NULL,462),

(10389,'2016-10-03','2016-10-09','2016-10-08','Shipped',NULL,448),

(10390,'2016-10-04','2016-10-11','2016-10-07','Shipped','They want to reevaluate their terms agreement with Finance.',124),

(10391,'2016-10-09','2016-10-20','2016-10-15','Shipped',NULL,276),

(10392,'2016-10-10','2016-10-18','2016-10-12','Shipped',NULL,452),

(10393,'2016-10-11','2016-10-22','2016-10-14','Shipped','They want to reevaluate their terms agreement with Finance.',323),

(10394,'2016-10-15','2016-10-25','2016-10-19','Shipped',NULL,141),

(10395,'2016-10-17','2016-10-24','2016-10-23','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',250),

(10396,'2016-10-23','2016-10-02','2016-10-28','Shipped',NULL,124),

(10397,'2016-10-28','2016-10-09','2016-10-01','Shipped',NULL,242),

(10398,'2016-10-30','2016-10-09','2016-10-31','Shipped',NULL,353),

(10399,'2016-10-01','2016-10-12','2016-10-03','Shipped',NULL,496),

(10400,'2016-10-01','2016-10-11','2016-10-04','Shipped','Customer requested that DHL is used for this shipping',450),

(10401,'2016-10-03','2016-10-14',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',328),

(10402,'2016-10-07','2016-10-14','2016-10-12','Shipped',NULL,406),

(10403,'2016-10-08','2016-10-18','2016-10-11','Shipped',NULL,201),

(10404,'2016-10-08','2016-10-14','2016-10-11','Shipped',NULL,323),

(10405,'2016-10-14','2016-10-24','2016-10-20','Shipped',NULL,209),

(10406,'2016-10-15','2016-10-25','2016-10-21','Disputed','Customer claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.',145),

(10407,'2016-10-22','2016-10-04',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',450),

(10408,'2016-10-22','2016-10-29','2016-10-27','Shipped',NULL,398),

(10409,'2016-10-23','2016-10-05','2016-10-24','Shipped',NULL,166),

(10410,'2016-10-29','2016-10-10','2016-10-30','Shipped',NULL,357),

(10411,'2016-10-01','2016-10-08','2016-10-06','Shipped',NULL,233),

(10412,'2016-10-03','2016-10-13','2016-10-05','Shipped',NULL,141),

(10413,'2016-10-05','2016-10-14','2016-10-09','Shipped','Customer requested that DHL is used for this shipping',175),

(10414,'2016-10-06','2016-10-13',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',362),

(10415,'2016-10-09','2016-10-20','2016-10-12','Disputed','Customer claims the scales of the models don\'t match what was discussed. I keep all the paperwork though to prove otherwise',471),

(10416,'2016-10-10','2016-10-16','2016-10-14','Shipped',NULL,386),

(10417,'2016-10-13','2016-10-19','2016-10-19','Disputed','Customer doesn\'t like the colors and precision of the models.',141),

(10418,'2016-10-16','2016-10-24','2016-10-20','Shipped',NULL,412),

(10419,'2016-10-17','2016-10-28','2016-10-19','Shipped',NULL,382),

(10420,'2016-10-29','2016-10-07',NULL,'In Process',NULL,282),

(10421,'2016-10-29','2016-10-06',NULL,'In Process','Custom shipping instructions were sent to warehouse',124),

(10422,'2016-10-30','2016-10-11',NULL,'In Process',NULL,157),

(10423,'2016-10-30','2016-10-05',NULL,'In Process',NULL,314),

(10424,'2016-10-31','2016-10-08',NULL,'In Process',NULL,141),

(10425,'2016-10-31','2016-10-07',NULL,'In Process',NULL,119);
...
('S12_1108','2016 Ferrari Enzo','Classic Cars','1:12','Second Gear Diecast','Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',3619,'95.59','207.80'),
...
('S12_2823','2016 Suzuki XREO','Motorcycles','1:12','Unimax Art Galleries','Official logos and insignias, saddle bags located on side of motorcycle, detailed engine, working steering, working suspension, two leather seats, luggage rack, dual exhaust pipes, small saddle bag located on handle bars, two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand, diecast metal with plastic parts and baked enamel finish.',9997,'66.27','150.62'),
...
('S24_3432','2016 Chevy Corvette','Classic Cars','1:24','Gearbox Collectibles','The operating parts of this limited edition Diecast 2016 Chevy Corvette 50th Anniversary Pace car Limited Edition are particularly delicate due to their precise scale and require special care and attention. Features rotating wheels, poseable streering, opening doors and trunk.',9446,'62.11','107.08'),
...
('S50_4713','2016 Yamaha YZR M1','Motorcycles','1:50','Autoart Studio Design','Features rotating wheels , working kick stand. Comes with stand.',600,'34.17','81.36'),
